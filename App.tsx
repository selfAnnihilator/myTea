...
const App: React.FC = () => {
  ...
  // This effect applies the background styles directly to the <body> element for robustness.
  useEffect(() => {
    // Set styles
    document.body.style.backgroundColor = '#030712'; // Dark fallback color
    // Use a relative path for the background image. This assumes 'background.png' is served from the same directory as index.html
    document.body.style.backgroundImage = `url('./background.png')`; 
    document.body.style.backgroundSize = 'cover';
    document.body.style.backgroundPosition = 'center';
    document.body.style.backgroundAttachment = 'fixed';

    // Cleanup function to remove the styles when the App component unmounts
    return () => {
  ...
  return (
    <div 
      className="font-sans antialiased text-white selection:bg-teal-300 selection:text-black min-h-screen"
      // Background styles are now applied directly to the body element via useEffect
    >
      <CustomCursor />
      <main>
        <Navbar
