...
const GoArrowUpRight: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 5L10 7L14.5858 7L5.29289 16.2929L6.70711 17.7071L16 8.41421L16 13L18 13L18 5L10 5Z"></path>
  </svg>
);
...
const Navbar: React.FC<NavbarProps> = ({
  ...
  const createTimeline = () => {
    ...
    tl.to(cardsRef.current.filter(el => el), { y: 0, opacity: 1, duration: 0.4, ease, stagger: 0.08 }, '-=0.1');
